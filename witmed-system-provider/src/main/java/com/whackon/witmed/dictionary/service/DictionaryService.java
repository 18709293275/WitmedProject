package com.whackon.witmed.dictionary.service;
...
public interface DictionaryService {
     ...
     * @throws Exception
     */
    PageVO<DictionaryVO> getPageByQuery(DictionaryVO queryVO, PageVO<DictionaryVO> pageVO) throws Exception;
     ...
     * @throws Exception
     */
    List<DictionaryVO> getListByQuery(DictionaryVO queryVO) throws Exception;
